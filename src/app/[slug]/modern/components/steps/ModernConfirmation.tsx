    ...
    <div>
      ...
      >
        ...
        <div className="relative w-20 h-20 mx-auto mb-6">
          ...
          >
            <svg className="w-9 h-9" style={{ color: theme.primaryColor }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <motion.path
                strokeLinecap="round"
        ...
        >
          {selectedService && (
            <p className="text-sm mb-1" style={{ color: 'var(--t-muted)', fontFamily: 'var(--font-inter)' }}>
      ...
      >
        ...
        <div className="px-5 py-4">
          {customerDetails?.email && (
            <p className="text-sm" style={{ color: 'var(--t-muted)', fontFamily: 'var(--font-inter)', lineHeight: 1.6 }}>
      ...
      >
        <div className="grid grid-cols-2 gap-3">
          <motion.button
            ...
            className="py-3 rounded-xl text-sm font-medium transition-colors modern-glass"
            style={{
